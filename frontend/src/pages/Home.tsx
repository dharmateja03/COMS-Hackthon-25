              ...
              <div className="relative h-[400px] lg:h-[500px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <svg className="w-full h-full" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* Grid lines */}
                    {[...Array(8)].map((_, i) => <line key={`h-${i}`} x1="50" y1={50 + i * 50} x2="350" y2={50 + i * 50} stroke="#1e293b" strokeWidth="1" />)}
                    {[...Array(7)].map((_, i) => <line key={`v-${i}`} x1={50 + i * 50} y1="50" x2={50 + i * 50} y2="350" stroke="#1e293b" strokeWidth="1" />)}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-[#1e293b] border border-gray-700 rounded-xl p-8 hover:border-cyan-400 transition-colors">
                ...
                <p className="text-gray-400">
                  PDFs, lecture notes, any text file.
                </p>
              </div>
              ...
              <div className="bg-[#1e293b] border border-gray-700 rounded-xl p-8 hover:border-cyan-400 transition-colors">
                ...
                <p className="text-gray-400">
                  Test your knowledge and track your confidence.
                </p>
              </div>
            </div>
          </div>
